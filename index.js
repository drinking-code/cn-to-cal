...
(async () => {
    function getNonOccurring(mainArr, targetArr) {
        ...
        // -> variable to be able to compare events later
    ...
    // fs.writeFileSync('cn-events.json', JSON.stringify(eventsCN))
    const eventsCN = JSON.parse(fs.readFileSync('cn-events.json'))
